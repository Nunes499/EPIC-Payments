...
export default function CriarReferenciaPage() {
  ...
  const [
    ...
    MultibancoReferenceResponse | null
  >(null);
  ...
  async function loadSmsHistory() {
    try {
      ...
      console.error(
        "Erro ao carregar histórico de SMS:",
        error,
      );
    } finally {
      setLoadingHistory(
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              <div
                className={
                  styles.messageChoice
                }
              >
                <div
                  className={
                    styles.messageChoiceHeader
                  }
                >
                  <MessageSquareText
                    size={20}
        ...
        >
          ...
          {loadingHistory ? (
            ...
            >
              Ainda não existem SMS
              registados nesta função.
            </div>
          ) : (
            <div
              className={
